   ...
   function getParameters()
   {
    ...
    function initGL(equirectangle, image, xml) {
           ...
           // getHotspots(xmlDoc);
            ...
            var angularSpeed = 0.00; // revolutions per second
            var lastTime = 0;
            var fov = 30;

            var container = document.getElementById( 'bubbleViewer' );
            var fullScreenContainer = document.getElementById( 'fullScreenContainer' );
            
            var projector = new THREE.Projector();
            // renderer
            var renderer = new THREE.WebGLRenderer();
            renderer.setSize(610, 344);
            ...
            //Logo
            var logo = new THREE.Mesh( new THREE.PlaneGeometry(18,12), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/logo.png' ), transparent: true } ) );

            //Button left
            //var left_bt = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/left01.png' ), transparent: true } ) );
            //var left_bt2 = new THREE.Mesh( new THREE.PlaneGeometry(10,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/left02.png' ), transparent: true } ) );

            //Button rigth
           // var right_bt = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/right01.png' ), transparent: true } ) );
            //var right_bt2 = new THREE.Mesh( new THREE.PlaneGeometry(10,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/right02.png' ), transparent: true } ) );

            //Button stop
            var stop_bt = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/auto_stop01.png' ), transparent: true } ) );
            var stop_bt2 = new THREE.Mesh( new THREE.PlaneGeometry(10,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/auto_stop02.png' ), transparent: true } ) );

            //Button start
            var start_bt = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/auto_start01.png' ), transparent: true } ) );
            var start_bt2 = new THREE.Mesh( new THREE.PlaneGeometry(10,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/auto_start02.png' ), transparent: true } ) );

            //Button display
            var display_bt = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/display01.png' ), transparent: true } ) );
            var display_bt2 = new THREE.Mesh( new THREE.PlaneGeometry(10,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/display02.png' ), transparent: true } ) );
            ...
            var stillMaterial = new THREE.MeshLambertMaterial({
				...
				if(isEquirectangle)
				{
					var sphere = new THREE.Mesh( new THREE.SphereGeometry(true, 1000, 64, 256), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( image ), side : THREE.DoubleSide } ) );
					sphere.scale.x = -1;
				}
				else{
            ...
            for (var i = 0; i < hotspots.length; i++) {
                var hotspotLogo = new THREE.Mesh( new THREE.PlaneGeometry(9,6), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../../object_images/hotspot.png' ), transparent: true } ) );
           ...
           function fullScreen(){    
            ...
            function objectPosition(){
                 ...
                 if(isEquirectangle){
                    ...
                    stop_bt.position.set(15.5*(windowWidth/windowHeight),-48,-25);
                    ...
                    start_bt.position.set(15.5*(windowWidth/windowHeight),-48,-25);
                    ...
                    stop_bt.position.set(37*(windowWidth/windowHeight),-18.5,-50);
                    stop_bt2.position = stop_bt.position;
                    ...
                    start_bt.position.set(37*(windowWidth/windowHeight),-18.5,-50);
                    start_bt2.position = start_bt.position;
    ...
    function animate(lastTime, angularSpeed, three, player){
            ...
            if(!isUserInteracting && !isStopInteracting){
                ...
                if(eventMouseX < onMouseDownMouseX)
                    three.global.rotation.y += Math.exp((onMouseDownMouseX - eventMouseX)*0.001) * 0.01;
                else if(eventMouseX > onMouseDownMouseX)
                   three.global.rotation.y -= Math.exp((eventMouseX-onMouseDownMouseX)*0.001) * 0.01;
           }
           lastTime = time;
